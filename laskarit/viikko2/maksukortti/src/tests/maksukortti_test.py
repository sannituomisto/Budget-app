...
class TestMaksukortti(unittest.TestCase):
    def setUp(self):
        ...
        self.edullinenkortti = Maksukortti(2.5)
    ...
    def test_pystyy_ostamaan_edullisen_vain(self):
        self.edullinenkortti.syo_edullisesti()
        self.assertEqual(str(self.edullinenkortti), "Kortilla on rahaa 0.0 euroa")

    def test_pystyy_ostamaan_maukkaan_vain(self):
