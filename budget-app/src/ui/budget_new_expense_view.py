...
class BudgetNewExpenseView:
    def __init__(self, root, handle_budget_start):
        self._root = root
        self._frame = None
    ...
    def _view(self):
        ...
        option_menu = ttk.OptionMenu(
            self._frame, self._option_var, self._categories[0], *self._categories)
        ...
        self._expense_amount_entry.grid(row=3, column=0, sticky=(
