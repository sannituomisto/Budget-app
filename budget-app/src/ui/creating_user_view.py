...
class CreateNewUserView:
    ...
    def _creating_user_handler(self):
        ...
        try:
            ...
            self._show_error(f'Choose another username, {username} already exists')
    ...
    def _view(self):
        ...
        create_button = ttk.Button(master=self._frame, text="CREATE USER",command=self._creating_user_handler)
        ...
        login_button.grid(row=6, column=0,sticky=(constants.E, constants.W), padx=140, pady=5)
