...
class TestRepositories(unittest.TestCase):
    ...
    def test_create_expense(self):
        self.testrepo.create(self.user_1)
        test=self.testrepo2.create(self.expense_1)
        self.assertEqual(test, "Expense entered successfully")

    def test_find_all_expense(self):
        self.testrepo.create(self.user_1)
        self.testrepo2.create(self.expense_1)
        self.testrepo2.create(self.expense_2)
        test=budget_repository.find_all_expense()
